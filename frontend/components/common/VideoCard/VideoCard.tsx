...
const VideoCard: React.FC<VideoCardProps> = (props) => {
  const { thumbnails, title, description, channelTitle, statistics, sharedBy } =
    props.data;

  return (
    <div className='animate-fade-in flex w-[60rem] cursor-pointer gap-6 rounded-2xl p-6 opacity-0 shadow-lg ring-1 ring-foreground/5 ring-opacity-0 dark:ring-foreground/15'>
      ...
      <div className='flex flex-col gap-2'>
        <h3 className='line-clamp-2 overflow-ellipsis text-lg font-semibold'>{title}</h3>
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <p className='text-sm text-muted-foreground'>Shared by {sharedBy.userName}</p>
          </div>
